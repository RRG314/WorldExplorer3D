...
- Never print raw cloud Function configuration, environment maps, credential files, or secret-bearing audit snapshots. Allowlist safe metadata before output. Keep credential material outside the repository and its generated evidence folders with owner-only permissions. Historical private snapshots were preserved in `/Users/stevenreid/Library/Application Support/WorldExplorer3D/verification-private`; do not include their contents in searches, reports, or uploads.
