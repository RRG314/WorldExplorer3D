...
| Aviation | `app/js/plane-mode.js`, `app/js/plane/`, `app/js/transport/aviation-*` | One fixed-wing flight controller, class-specific flight response, generated playable airport fleets, bounded taxi activity, aircraft presentation, and recovery |
