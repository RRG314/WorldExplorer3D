...
| Aviation | `app/js/plane-mode.js`, `app/js/plane/`, `app/js/transport/airport-*`, `app/js/transport/aviation-*` | One flight controller and airport layout authority; class-specific flight response, playable parked/taxiing fleets, bounded traffic circuits, aircraft collision, pilot/passenger travel, airport arrivals, skydiving handoff, presentation, and recovery |
