...
> **Current branch update:** See the [September 11 system and architecture report](SYSTEM_REPORT_2026-09-11.md) for subsequent repairs, the live Gemini research pilot, and current verification limits. This page describes the September 10 product baseline.
