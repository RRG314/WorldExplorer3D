function getGlobeSelectorElements() {
  return {
    ...
    mapBasemapBtn: document.getElementById('globeSelectorMapBasemapBtn'),
    satelliteBasemapBtn: document.getElementById('globeSelectorSatelliteBasemapBtn'),
    basemapAttribution: document.getElementById('globeSelectorBasemapAttribution'),
    zoomInBtn: document.getElementById('globeSelectorZoomInBtn'),
    zoomOutBtn: document.getElementById('globeSelectorZoomOutBtn'),
    scaleReadout: document.getElementById('globeSelectorScaleReadout'),
