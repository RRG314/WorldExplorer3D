...
const POI_TYPES = {
  ...
  'amenity=charging_station': { icon: '⚡', category: 'Services', color: 0x42a5f5 },
  ...
  'amenity=doctors': { icon: '✚', category: 'Healthcare', color: 0xef5350 },
  'amenity=veterinary': { icon: '🐾', category: 'Pet Care', color: 0x26a69a },
  'amenity=veterinary_pharmacy': { icon: '🐾', category: 'Pet Care', color: 0x26a69a },
  'amenity=marketplace': { icon: '🏪', category: 'Shopping', color: 0x66bb6a },
  'amenity=dive_centre': { icon: '⚓', category: 'Marine', color: 0x0277bd },
  ...
  'shop=general': { icon: '🏪', category: 'Shopping', color: 0x66bb6a },
  'shop=kiosk': { icon: '🏪', category: 'Shopping', color: 0x66bb6a },
  'shop=department_store': { icon: '🏬', category: 'Shopping', color: 0x43a047 },
  'shop=hardware': { icon: '🔧', category: 'Shopping', color: 0x8d6e63 },
  'shop=doityourself': { icon: '🔧', category: 'Shopping', color: 0x8d6e63 },
  'shop=pawnbroker': { icon: '◇', category: 'Shopping', color: 0xc49a45 },
  'shop=second_hand': { icon: '♻', category: 'Shopping', color: 0x78909c },
  'shop=car_repair': { icon: '🔧', category: 'Services', color: 0x607d8b },
  'shop=car_parts': { icon: '⚙', category: 'Shopping', color: 0x607d8b },
  'shop=tyres': { icon: '⚙', category: 'Services', color: 0x607d8b },
  'shop=pet': { icon: '🐾', category: 'Pet Care', color: 0x26a69a },
  'shop=outdoor': { icon: '⛺', category: 'Shopping', color: 0x558b2f },
  'shop=sports': { icon: '⛺', category: 'Shopping', color: 0x558b2f },
  'shop=hunting': { icon: '⛺', category: 'Shopping', color: 0x558b2f },
  'shop=scuba_diving': { icon: '⚓', category: 'Marine', color: 0x0277bd },
  'shop=fishing': { icon: '🎣', category: 'Shopping', color: 0x0288d1 },
  'shop=boat': { icon: '⛵', category: 'Shopping', color: 0x0277bd },
  'shop=aviation': { icon: '✈', category: 'Shopping', color: 0x546e7a },
  'shop=clothes': { icon: '◈', category: 'Shopping', color: 0x8e7cc3 },
  'shop=shoes': { icon: '◈', category: 'Shopping', color: 0x8e7cc3 },
  'healthcare=hospital': { icon: '🏥', category: 'Healthcare', color: 0xf44336 },
  'healthcare=clinic': { icon: '🏥', category: 'Healthcare', color: 0xe91e63 },
  'healthcare=doctor': { icon: '✚', category: 'Healthcare', color: 0xef5350 },
  'healthcare=doctors': { icon: '✚', category: 'Healthcare', color: 0xef5350 },
  'healthcare=pharmacy': { icon: '💊', category: 'Healthcare', color: 0x66bb6a },
  'leisure=marina': { icon: '⚓', category: 'Marine', color: 0x0277bd },
