...
const DEFAULT_CREW = Object.freeze([
  Object.freeze({ id: 'player', name: 'Explorer', ageYears: 34, roles: Object.freeze(['command', 'science']), status: 'active' }),
  Object.freeze({ id: 'crew-nav', name: 'Mara Velez', ageYears: 39, roles: Object.freeze(['navigation', 'command']), status: 'active' }),
  Object.freeze({ id: 'crew-eng', name: 'Dev Malik', ageYears: 42, roles: Object.freeze(['engineering', 'fabrication']), status: 'active' }),
  Object.freeze({ id: 'crew-life', name: 'Avery Okafor', ageYears: 36, roles: Object.freeze(['life-support', 'engineering']), status: 'active' }),
  Object.freeze({ id: 'crew-med', name: 'Jules Park', ageYears: 41, roles: Object.freeze(['medical', 'life-support']), status: 'active' }),
  Object.freeze({ id: 'crew-science', name: 'Noor Haddad', ageYears: 33, roles: Object.freeze(['science', 'navigation']), status: 'active' }),
  Object.freeze({ id: 'crew-flight', name: 'Tessa Morgan', ageYears: 38, roles: Object.freeze(['navigation', 'command']), status: 'active' }),
  Object.freeze({ id: 'crew-systems', name: 'Eli Chen', ageYears: 45, roles: Object.freeze(['engineering', 'medical']), status: 'active' })
]);
