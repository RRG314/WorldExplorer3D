...
const EQUIPMENT_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({ id: 'concussion-charge', label: 'Explorer grenade', category: 'explosive', slot: 5, range: 26, force: 78, blastRadius: 7.5, cooldownMs: 1100, quantity: 4, projectileKind: 'thrown-charge', projectileSpeed: 18, fuseSeconds: 2.2, actionLabel: 'Throw', icon: 'GRENADE', verbs: ['equip', 'use'] }),
