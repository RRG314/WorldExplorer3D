...
const EQUIPMENT_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({ id: 'pulse-sidearm', label: 'Pulse sidearm', category: 'sidearm', slot: 4, range: 100, force: 34, cooldownMs: 310, magazineSize: 12, reserve: 36, projectileKind: 'pulse', projectileSpeed: 72, actionLabel: 'Fire', icon: 'PULSE', verbs: ['equip', 'use'] }),
  Object.freeze({ id: 'concussion-charge', label: 'Concussion charge', category: 'explosive', slot: 5, range: 26, force: 78, blastRadius: 7.5, cooldownMs: 1100, quantity: 4, projectileKind: 'thrown-charge', projectileSpeed: 18, fuseSeconds: 2.2, actionLabel: 'Throw', icon: 'CHARGE', verbs: ['equip', 'use'] }),
  ...
  Object.freeze({ id: 'laser-gun', label: 'Laser gun', category: 'sidearm', slot: null, range: 160, force: 42, cooldownMs: 230, magazineSize: 20, reserve: 80, projectileKind: 'laser', projectileSpeed: 112, actionLabel: 'Fire', icon: 'LASER', verbs: ['equip', 'use'] }),
  Object.freeze({ id: 'paintball-gun', label: 'Paintball gun', category: 'sidearm', slot: null, range: 55, force: 9, cooldownMs: 145, magazineSize: 30, reserve: 120, projectileKind: 'paintball', projectileSpeed: 44, projectileGravity: 4.8, actionLabel: 'Fire', icon: 'PAINT', verbs: ['equip', 'use'] }),
  Object.freeze({ id: 'compact-sidearm', label: 'Compact sidearm', category: 'sidearm', slot: null, starter: false, range: 90, force: 27, cooldownMs: 360, magazineSize: 10, reserve: 0, projectileKind: 'pulse', projectileSpeed: 68, actionLabel: 'Fire', icon: 'COMPACT', verbs: ['equip', 'use'] }),
  Object.freeze({ id: 'responder-sidearm', label: 'Response sidearm', category: 'sidearm', slot: null, starter: false, range: 110, force: 32, cooldownMs: 280, magazineSize: 15, reserve: 0, projectileKind: 'pulse', projectileSpeed: 78, actionLabel: 'Fire', icon: 'RESPONSE', verbs: ['equip', 'use'] })
]);
