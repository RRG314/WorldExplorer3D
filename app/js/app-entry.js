...
import './runtime-diagnostics.js?v=55';
import './ui/legal-attribution.js?v=1';
import './state.js?v=63';
...
import './transport/actor-contract.js?v=3';
...
import './physics.js?v=119';
import './walking.js?v=83';
...
import { installOnDemandEarth } from './runtime/on-demand-earth.js?v=144';
