...
import './runtime-diagnostics.js?v=74';
...
import './walking.js?v=89';
import './travel-mode.js?v=24';
import { initBoatMode } from './boat-mode.js?v=57';
import './sky.js?v=88';
import './weather.js?v=11';
import './runtime/on-demand-modes.js?v=36';
import { installOnDemandEarth } from './runtime/on-demand-earth.js?v=173';
...
import { setupUI } from './ui.js?v=154';
