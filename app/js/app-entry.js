...
import './controls/action-input.js?v=5';
...
import { init, tryEnablePostProcessing } from './engine.js?v=83';
import './physics.js?v=90';
import './walking.js?v=68';
import './travel-mode.js?v=18';
...
import { setupUI } from './ui.js?v=115';
