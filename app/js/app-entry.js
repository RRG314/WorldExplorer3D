...
import './runtime-diagnostics.js?v=57';
...
import './transport/actor-contract.js?v=4';
...
import './physics.js?v=120';
import './walking.js?v=85';
...
import { installOnDemandEarth } from './runtime/on-demand-earth.js?v=147';
