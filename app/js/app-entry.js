...
import './runtime-diagnostics.js?v=61';
...
import './walking.js?v=86';
import './travel-mode.js?v=23';
import { initBoatMode } from './boat-mode.js?v=51';
import './sky.js?v=88';
import './weather.js?v=10';
import './runtime/on-demand-modes.js?v=12';
import { installOnDemandEarth } from './runtime/on-demand-earth.js?v=157';
