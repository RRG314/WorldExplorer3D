...
import { init, tryEnablePostProcessing } from './engine.js?v=97';
import './physics.js?v=127';
import './walking.js?v=94';
import './travel-mode.js?v=28';
import { initBoatMode } from './boat-mode.js?v=58';
import './sky.js?v=89';
import './weather.js?v=11';
import './runtime/on-demand-modes.js?v=48';
import { installOnDemandEarth } from './runtime/on-demand-earth.js?v=176';
...
import { setupUI } from './ui.js?v=168';
