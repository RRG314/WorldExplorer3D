...
import './terrain.js?v=161';
import './world.js?v=259';
import './building-entry.js?v=5';
import './interiors.js?v=9';
import { init, tryEnablePostProcessing } from './engine.js?v=81';
import './physics.js?v=84';
import './walking.js?v=68';
import './travel-mode.js?v=13';
import { initBoatMode } from './boat-mode.js?v=33';
