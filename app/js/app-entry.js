...
import { installOnDemandEarth } from './runtime/on-demand-earth.js?v=133';
import { installOnDemandBlockBuilder } from './runtime/on-demand-block-builder.js?v=9';
...
import './planetary/field-activities.js?v=7';
import './game.js?v=62';
