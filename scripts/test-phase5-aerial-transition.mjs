...
assert.doesNotMatch(farFieldSource, /mappedWaterKindAt|waterByTile|mappedWaterPolygons/);
assert.doesNotMatch(farFieldSource, /\['ocean', 'water_polygons'\]/);
assert.match(farFieldSource, /waterOwner: 'mapped-polygon-and-ribbon-pipeline'/);
