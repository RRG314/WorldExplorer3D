...
assert.match(universeVisuals, /SphereGeometry\(18000/, 'the Milky Way observation must project at sky distance');
assert.match(universeVisuals, /not asserted as physical volumetric data/, 'nebula depth limitations must remain explicit');
