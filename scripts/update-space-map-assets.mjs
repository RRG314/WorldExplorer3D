...
for (const [id,model] of Object.entries({triton:'t/Triton_1_2707',ceres:'c/Ceres_1_1000',vesta:'v/Vesta_1_100',enceladus:'e/Enceladus_1_504',ganymede:'g/Ganymede_1_5268',callisto:'c/Callisto_1_4821',uranus:'u/Uranus_1_51118',neptune:'n/Neptune_1_49528',venus:'v/Venus_1_12103'})) {
 ...
 const file=`app/assets/textures/${id}-nasa-vtad-${id==='venus'?'clouds':'map'}.jpg`;
