...
export const currentContractTests = [
  ...
  'tests/interstellar-shared-authority.test.cjs',
  'tests/maritime-roof-release-paths.test.mjs',
  'tests/property-authority.test.cjs',
  'tests/shared-block-sync.test.mjs',
  'tests/survey-association.test.mjs',
  'tests/survey-metadata.test.mjs',
  'tests/firebase-environment-isolation.test.mjs',
  ...
  'tests/owned-browser-current.test.mjs',
  'tests/engine-pause-input-current.test.mjs',
  'tests/release-finalization-current.test.mjs',
