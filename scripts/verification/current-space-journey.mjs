...
try {
  ...
  await page.screenshot({ path: path.join(evidenceDir, '02-active-space-course.png') });
  ...
  await page.screenshot({ path: path.join(evidenceDir, '03-space-journey-mobile.png') });
