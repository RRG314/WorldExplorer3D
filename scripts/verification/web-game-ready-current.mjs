...
const client=process.env.WE3D_GAME_CLIENT || new URL('skills/develop-web-game/scripts/web_game_playwright_client.js', 'file://' + (process.env.CODEX_HOME || process.env.HOME + '/.codex') + '/').pathname;
