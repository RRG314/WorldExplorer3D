...
const steps = [
  ...
  { name: 'Real-input sustained drive', cmd: [process.execPath, 'scripts/test-player-input-drive.mjs'] },
  ...
  { name: 'Production evidence gate', cmd: [process.execPath, 'scripts/verify-production-gate.mjs'] }
];
