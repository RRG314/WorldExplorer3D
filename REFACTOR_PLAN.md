...
- `app/js/world.js`: 4088 lines in the clean refactor workspace (`7549` at original baseline)
...
- current line-count reduction in the clean live-fix workspace: `7549 -> 4088`
- remaining to close phase: reduce `app/js/world.js` from 4088 lines to 1500 or less through additional targeted extractions
