...
The previous two-arm memory comparison is deferred, not silently extended. Its old limits would answer a different question. First choose the time policy: real-time observation over hours, or accelerated world time with a separately validated action-opportunity model. Do not compare those policies as interchangeable trials.
