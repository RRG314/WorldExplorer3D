...
The [next-interface amendment](../NAVIGATION-FEEDBACK.md) bounds observed heading, exposes actual configured control rates and supplies signed bearings and body-relative offsets for already-visible resources. Controlled tests use the retained physics to verify turn direction, rate, heading equivalence and approach to targets. These additions supply interpretable observations, not automatic routes. No new live outcome is claimed from this amendment.
