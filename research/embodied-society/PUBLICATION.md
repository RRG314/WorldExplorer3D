...
The corrected remote research and complete-history secret checks passed at public commit `67030d7681d5f0f73f781e99ac64b7a4d4592222`; the evidence JSON includes their GitHub URLs. Current action release versions replace deprecated runner-runtime actions. CI results always belong to their named commit; later edits trigger fresh checks. The initial failed scan remains visible and is not counted as passing.
